...
class test_api(unittest.TestCase):
	...
	def test_summarize(self):
		"""check wiki resume"""
		response = """Tokyo /to.kjo/ (東京, Tōkyō, /toːkʲoː/ , litt. « Capitale de l'est »), anciennement Edo (江戸), officiellement Métropole de Tokyo (東京都, Tōkyō-to), est de facto la capitale actuelle du Japon. Elle est la plus peuplée des préfectures du Japon, avec plus de 14 831 421 habitants intra-muros en 2018 et 42 794 714 dans l'agglomération, et forme l'aire urbaine la plus peuplée au monde.
